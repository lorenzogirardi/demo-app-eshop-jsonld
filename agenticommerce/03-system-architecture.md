...
src/
  ...
  lib/
    ai/   llm, config, client(Enthusiast), search, chat, enrichment, validator, categories, store, types
...
enthusiast/        # untracked upstream checkout + custom plugin eshop_source
```
